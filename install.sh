...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202304151949-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.com
# @@License          :  LICENSE.md
# @@ReadME           :  install.sh --help
# @@Copyright        :  Copyright: (c) 2023 Jason Hempstead, Casjays Developments
# @@Created          :  Saturday, Apr 15, 2023 19:49 EDT
# @@File             :  install.sh
...
HUB_IMAGE_URL="casjaysdevdocker/coolify"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Set container hostname and domain - Default: [coolify.$SET_HOST_FULL_NAME] [$SET_HOST_FULL_DOMAIN]
CONTAINER_HOSTNAME=""
...
EOF
  ...
  sed -i "s|$HUB_IMAGE_URL:$HUB_IMAGE_TAG|\\\\\n  $HUB_IMAGE_URL:$HUB_IMAGE_TAG $CONTAINER_COMMANDS|g" "$DOCKERMGR_INSTALL_SCRIPT" 2>/dev/null
}
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
if [ -n "$COOLIFY_USERNAME" ]; then
  CONTAINER_USER_NAME="$COOLIFY_USERNAME"
fi
if [ -n "$CONTAINER_USER_NAME" ]; then
  CONTAINER_USER_NAME="${COOLIFY_USERNAME:-${CONTAINER_USER_NAME:-$DEFAULT_USERNAME}}"
fi
if [ -n "$CONTAINER_USER_NAME" ]; then
